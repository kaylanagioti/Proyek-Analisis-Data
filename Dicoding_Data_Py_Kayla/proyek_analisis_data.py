...
def load_data():
    orders = pd.read_csv('https://github.com/kaylanagioti/Proyek-Analisis-Data/blob/main/Dicoding_Data_Py_Kayla/data/olist_orders_dataset.csv')
    order_items = pd.read_csv('https://github.com/kaylanagioti/Proyek-Analisis-Data/blob/main/Dicoding_Data_Py_Kayla/data/olist_order_items_dataset.csv')
    products = pd.read_csv('https://github.com/kaylanagioti/Proyek-Analisis-Data/blob/main/Dicoding_Data_Py_Kayla/data/olist_products_dataset.csv')
    order_reviews = pd.read_csv('https://github.com/kaylanagioti/Proyek-Analisis-Data/blob/main/Dicoding_Data_Py_Kayla/data/olist_order_reviews_dataset.csv')
